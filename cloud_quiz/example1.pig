...
-- the above doesn't work because we're in a different region, so download the files, upload on hdfs and load:
-- hadoop@ip-10-232-24-217:~$ wget http://uw-cse-344-oregon.aws.amazon.com.s3.amazonaws.com/btc-2010-chunk-000
-- hadoop@ip-10-232-24-217:~$ hadoop fs -copyFromLocal btc-2010-chunk-000 /user/hadoop/2gdata
...
store count_by_object into '/user/hadoop/results-count_by_object' using PigStorage();